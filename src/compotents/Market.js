...
import { View, StyleSheet, FlatList, TouchableHighlight, Dimensions, ToastAndroid } from 'react-native';
...
export default class Marklet extends Component{
    constructor(props){
        super(props);
        this.state={
            text:'popular',
    ...
    _getListItem = ({item}) => (<TouchableHighlight onPress={()=>{this.props.onPressHandle(item)}}><ImagesList data={item} /></TouchableHighlight>);
    render(){
        return  (
            <View style={styles.container}>
                <View style={styles.inputBox}>
                    <TouchableHighlight><SearchInput onFocus={()=>{this.props.onPressSearch()}} style={styles.input} placeholder='搜点什么呢'/></TouchableHighlight>
                </View>
